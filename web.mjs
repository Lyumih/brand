...
;
	($.$brand_app_color) = class $brand_app_color extends ($.$mol_page) {
		GitHub(){
			const obj = new this.$.$mol_link_source();
			(obj.uri) = () => ("https://github.com/Lyumih/brand");
			return obj;
		}
		color(next){
			if(next !== undefined) return next;
		...
		Theme_link(){
			const obj = new this.$.$mol_link_iconed();
			(obj.title) = () => ("Исходник тем $mol");
			(obj.uri) = () => ("https://github.com/hyoo-ru/mam_mol/tree/master/theme");
			return obj;
		}
		Themes(){
			const obj = new this.$.$mol_text();
			(obj.text) = () => ("Темы $mol: *mol_theme_light, mol_theme_dark, mol_theme_current, mol_theme_special, mol_theme_accent*");
			return obj;
		}
		Keys(){
			const obj = new this.$.$mol_text();
			(obj.text) = () => ("Ключи темы: *back, hover, card, current, special, text, control, shade, line, focus, field, image*");
			return obj;
		}
		Source(){
			const obj = new this.$.$mol_text();
			(obj.text) = () => ("Исходный цвет: #222");
			return obj;
		}
		Target(){
			const obj = new this.$.$mol_string();
			(obj.hint) = () => ("Нужный цвет: #fafafa");
			return obj;
		}
		Formula(){
			const obj = new this.$.$mol_text();
	...
	($mol_mem(($.$brand_app_color.prototype), "GitHub"));
	($mol_mem(($.$brand_app_color.prototype), "color"));
	($mol_mem(($.$brand_app_color.prototype), "Themes_switcher"));
	($mol_mem(($.$brand_app_color.prototype), "Theme_link"));
	($mol_mem(($.$brand_app_color.prototype), "Themes"));
	($mol_mem(($.$brand_app_color.prototype), "Keys"));
	($mol_mem(($.$brand_app_color.prototype), "Source"));
	($mol_mem(($.$brand_app_color.prototype), "Target"));
	($mol_mem(($.$brand_app_color.prototype), "Formula"));
	($mol_mem(($.$brand_app_color.prototype), "Result"));
...
;
	($.$mol_icon_github_circle) = class $mol_icon_github_circle extends ($.$mol_icon) {
		path(){
...
;
	($.$brand_app_example) = class $brand_app_example extends ($.$mol_page) {
		Lighter(){
		...
		Button_major(){
			...
			(obj.title) = () => ("$mol_button_major");
			return obj;
		}
		Button_major_disabled(){
			const obj = new this.$.$mol_button_major();
			(obj.title) = () => ("$mol_button_major disabled");
			(obj.enabled) = () => (false);
			return obj;
		}
		Button_minor(){
		...
		Button_minor_disabled(){
			const obj = new this.$.$mol_button_minor();
			(obj.title) = () => ("$mol_button_minor disabled");
			(obj.enabled) = () => (false);
			return obj;
		}
		Buttons(){
			const obj = new this.$.$brand_app_example_section();
			(obj.title) = () => ("# Кнопки");
			(obj.content) = () => ([
				(this.Button_major()), 
				(this.Button_major_disabled()), 
				(this.Button_minor()), 
				(this.Button_minor_disabled())
			]);
			return obj;
		}
		Number(){
		...
		string_content(next){
			if(next !== undefined) return next;
			return "$mol_string значения";
		}
		String_content(){
			const obj = new this.$.$mol_string();
			(obj.value) = (next) => ((this.string_content(next)));
			return obj;
		}
		Inputs(){
			const obj = new this.$.$brand_app_example_section();
		...
		Checkbox(){
			...
			(obj.title) = () => ("Простой чекбокс");
			return obj;
		}
		Checkbox_checked(){
			const obj = new this.$.$mol_check_box();
			(obj.title) = () => ("Простой чекбокс - checked");
			(obj.checked) = () => (true);
			return obj;
		}
		Checkbox_disabled(){
			const obj = new this.$.$mol_check_box();
			(obj.title) = () => ("Простой чекбокс - disabled");
			(obj.enabled) = () => (false);
			return obj;
		}
		color(next){
	...
	($mol_mem(($.$brand_app_example.prototype), "Lighter"));
	($mol_mem(($.$brand_app_example.prototype), "Button_major"));
	($mol_mem(($.$brand_app_example.prototype), "Button_major_disabled"));
	($mol_mem(($.$brand_app_example.prototype), "Button_minor"));
	($mol_mem(($.$brand_app_example.prototype), "Button_minor_disabled"));
	($mol_mem(($.$brand_app_example.prototype), "Buttons"));
	($mol_mem(($.$brand_app_example.prototype), "Number"));
	($mol_mem(($.$brand_app_example.prototype), "String"));
	($mol_mem(($.$brand_app_example.prototype), "string_content"));
	($mol_mem(($.$brand_app_example.prototype), "String_content"));
	($mol_mem(($.$brand_app_example.prototype), "Inputs"));
	($mol_mem(($.$brand_app_example.prototype), "Checkbox"));
	($mol_mem(($.$brand_app_example.prototype), "Checkbox_checked"));
	($mol_mem(($.$brand_app_example.prototype), "Checkbox_disabled"));
	($mol_mem(($.$brand_app_example.prototype), "color"));
	($mol_mem(($.$brand_app_example.prototype), "Switcher"));
	($mol_mem(($.$brand_app_example.prototype), "Checkboxes"));
	($mol_mem(($.$brand_app_example.prototype), "Link"));
	($mol_mem(($.$brand_app_example.prototype), "Link_uri"));
	($mol_mem(($.$brand_app_example.prototype), "Link_iconed"));
	($mol_mem(($.$brand_app_example.prototype), "Links"));
	($mol_mem(($.$brand_app_example.prototype), "Icon_github"));
	($mol_mem(($.$brand_app_example.prototype), "Icons"));
	($.$brand_app_example_section) = class $brand_app_example_section extends ($.$mol_list) {
		title(){
			return "";
		}
		Section(){
	...
	($mol_mem(($.$brand_app_example_section.prototype), "Section"));
	($mol_mem(($.$brand_app_example_section.prototype), "Content"));
...
;
	($.$brand_app) = class $brand_app extends ($.$mol_book2) {
		Theme(){
			const obj = new this.$.$mol_theme_auto();
			return obj;
		}
		Color(){
			const obj = new this.$.$brand_app_color();
			return obj;
		}
		Example(){
			const obj = new this.$.$brand_app_example();
			return obj;
		}
		title(){
			return "Бренд $mol";
		...
		pages(){
			return [(this.Color()), (this.Example())];
		}
	};
	($mol_mem(($.$brand_app.prototype), "Theme"));
	($mol_mem(($.$brand_app.prototype), "Color"));
	($mol_mem(($.$brand_app.prototype), "Example"));
