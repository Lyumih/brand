...
(function ($) {
    class $brand_app extends $mol_book2_catalog {
        ...
        Source() {
            const obj = new this.$.$mol_string();
            obj.hint = () => "Исходный цвет";
            return obj;
        }
        Target() {
            const obj = new this.$.$mol_string();
            obj.hint = () => "Нужный цвет";
            return obj;
        }
        Result() {
            const obj = new this.$.$mol_string();
            obj.hint = () => "Итоговый css";
            return obj;
        }
        Color_page() {
            const obj = new this.$.$mol_page();
    ...
    __decorate([
        $mol_mem
    ], $brand_app.prototype, "Source", null);
    __decorate([
        $mol_mem
    ], $brand_app.prototype, "Target", null);
    __decorate([
        $mol_mem
    ], $brand_app.prototype, "Result", null);
    __decorate([
        $mol_mem
